...
class Potion(ItemCard):
    ...
    def use(self, deck):
        healed = min(20, deck.battlePokemon.maxHp - deck.battlePokemon.currentHp)
        deck.battlePokemon.currentHp += healed
        return f"{deck.battlePokemon.name}의 HP를 {healed}만큼 회복했습니다."